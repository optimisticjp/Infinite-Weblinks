...
- [ ] CHK-A20 — Sanity Studio editor preview (Presentation tool) confirmed keyboard-operable for the two editors, even though `/studio` itself is outside the public AA audit.

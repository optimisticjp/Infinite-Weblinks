          ...
          columns: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: "B2B & software", href: "/business-types/b2b-software" },
              ],
            },
            {
              heading: "By where you are",
              items: [
                { label: "Just starting out", href: "/starting-points/just-starting" },
                { label: "Have a site, need traffic", href: "/starting-points/need-traffic" },
                { label: "Traffic, but few sales", href: "/starting-points/few-sales" },
                { label: "Established & scaling", href: "/starting-points/scaling" },
              ],
            },
          ],
        },
